...
const VAGAS: FeedVagaItem[] = [
  {
    ...
    vaga: {
      ...
      posicoes: 1,
      empresa: { id: "e1", nome: "Trattoria Nonna Rosa", logo: null, setor: "restaurante", verificada: true },
  ...
  },
  {
    ...
    vaga: {
      ...
      posicoes: 1,
      empresa: { id: "e2", nome: "Hotel Villa Verde", logo: null, setor: "hotel", verificada: false },
      criadaEm: new Date().toISOString(),
    },
  },
  {
    ...
    vaga: {
      ...
      posicoes: 4,
      empresa: { id: "e3", nome: "Buffet Solar", logo: null, setor: "buffet", verificada: true },
      criadaEm: new Date().toISOString(),
    },
  },
];
